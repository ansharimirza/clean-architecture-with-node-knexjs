...
describe('Users repository', () => {
    ...
    test('New user should be deleted', async () => {
        ...
        //add two users
        const [willBeDeletedAddedUser, shouldStayAddedUser] = 
        await Promise.all([usersRepository.add(willBeDeletedUser), usersRepository.add(shoulStayUser)]);
        ...
        //check that second user defined (not deleted)
